...
public class principal {
    public static void main(String[] args) {
        ...
        emp.agregarEmpleado(new EmpleadoComision(30105856, "Manuel", "Diaz", 2017, 3000, 20000, 50));
        emp.agregarEmpleado(new EmpleadoComision(30267754, "Jeremias", "Montiel", 2021, 3000, 25000, 75));
        emp.agregarEmpleado(new EmpleadoComision(30105512, "Mateo", "Morgui", 2024, 2000, 10000, 50));
